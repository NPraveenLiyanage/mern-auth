...
import { updateUserFailurer, updateUserStart, updateUserSuccess } from '../redux/user/userSlice';
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        if (data.success === false) {
          dispatch(updateUserFailurer(data));
          return;
        }
        dispatch(updateUserSuccess(data));
        setUpdateSuccess(true);
      } catch (error) {
        dispatch(updateUserFailurer(error));
      }
    };
